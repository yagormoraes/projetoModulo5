...
function SobrePag() {
  ...
  return (
    <>
        ...
        <Sobre
        titulo={'Visão'}
         conteudo="Donec placerat consectetur elit a bibendum. Suspendisse eget pretium mauris. Vivamus rhoncus 
        ...
        <Sobre
        titulo={'Valores'}
         conteudo='Fusce sollicitudin fringilla elit, et venenatis sapien tincidunt et. Nullam facilisis ligula non orci 
